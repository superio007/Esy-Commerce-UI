      ...
      <div className="bg-white">
        ...
        >
          <div className="px-6 md:px-0">
            ...
            >
              <div>
                <h2 className={styles.CaarearH2}>What are the benefits?</h2>
                <p className={styles.CaarearP}>
                  We are a customer-first eCommerce agency, combining the best
                  of UX design, technology, <br /> and analytics to create sites
                  that shoppers love and retention tactics that keep them coming
                  back.
                </p>
              </div>
              <div className="mt-4 md:mt-0">
          ...
          <div className="grid grid-cols-1 justify-items-center sm:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-3 gap-y-6">
            {Jobs.map((volunteer, index) => (
              ...
              >
                ...
                {/* Title */}
                <h2 className={styles.CaarearH2}>{volunteer.job_title}</h2>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className={`${styles.CaarearP}`}>
                    {trimText(
                      volunteer.job_description || "No description available."
                    )}
                  </p>
                </div>
              ...
              <SwiperSlide key={index}>
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className={styles.CaarearH3}>Description</h3>
                    <p className={`${styles.CaarearP}`}>
                      {trimText(volunteer.job_description)}
                    </p>
                  </div>
