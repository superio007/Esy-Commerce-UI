import styles from "../../css/IdentityBrandingCommunication.module.css";
...
import IdentityBrandingCommunicationPageData from "../Data/IdentityBrandingCommunicationData.json";

const fetchIdentityBrandingCommunicationContent = async () => {
  const { data } = await axios.get(
    "https://whale-app-8hpek.ondigitalocean.app/api/identity-branding-communication?populate[service_hero_section][populate]=*&populate[service_over_view][populate]=*&populate[key_benift][populate]=*&populate[how_it_work][populate]=*&populate[why_us][populate]=*&populate[faq][populate]=*&populate[cta][populate]=*"
  );
  return data.data;
};
...
export default IdentityBrandingCommunication;
