...
import YoutubeContentMarketingPageData from "../Data/YoutubeContentMarketingData.json";

const fetchYoutubeContentMarketingContent = async () => {
  const { data } = await axios.get(
    "https://whale-app-8hpek.ondigitalocean.app/api/you-tube-content-marketing?populate[service_hero_section][populate]=*&populate[service_over_view][populate]=*&populate[key_benift][populate]=*&populate[how_it_work][populate]=*&populate[why_us][populate]=*&populate[faq][populate]=*&populate[cta][populate]=*"
  );
  return data.data;
};
const YoutubeContentMarketing = () => {
  ...
  const apiResponse = error
    ? YoutubeContentMarketingPageData.data || []
    : data || [];
...
export default YoutubeContentMarketing;
