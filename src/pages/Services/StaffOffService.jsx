import styles from "../../css/StaffOffService.module.scss";
...
const StaffOffServices = () => {
  ...
  const apiResponse = error ? StaffOffServicesPageData.data || [] : data || [];
...
export default StaffOffServices;
