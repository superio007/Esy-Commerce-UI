            ...
            <div>
              <div className="flex gap-8 flex-wrap p-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-bold">{job.experience_required}</h2>
                </div>
                <div className="flex items-center gap-2">
                  {/* Mode */}
                  <svg
                  ...
                  <h2 className="font-bold">{job.mode}</h2>
                </div>
                <div className="flex items-center gap-2">
                  {/* type */}
                  <svg
                  ...
                  <h2 className="font-bold">{job.contract_duration}</h2>
                </div>
              </div>
              ...
              <div className="py-4 flex flex-col  gap-8">
                <div className="flex md:justify-start justify-center gap-4">
                  <button className="">
                    <span className="flex gap-2 bg-[#ffffff00]  hover:text-[#007fff] border-[#007fff] cursor-pointer border-1 text-[#007fff] w-[60px] h-[60px] items-center justify-center rounded-full overflow-hidden shadow-lg">
            ...
            <div className="space-y-4">
              <div className=" p-6 bg-white rounded-xl">
                ...
                <div className="flex flex-col md:flex-row gap-2 pb-2 ">
                  <h3 className="font-medium text-[18px]">Company Name:</h3>
