...
const SinglePosting = () => {
  ...
  return (
    <>
      ...
      >
          <h1 className={`${styles.CareerPageHeading} text-center`}>{title}</h1>
          {SingleJob.map((job, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <p className={`${styles.headSub}`}>{job.experience_required}</p>
              </div>
              <div className="flex items-center gap-1">
                {/* Mode */}
                <svg
                ...
                <p className={`${styles.headSub}`}>{job.mode}</p>
              </div>
              <div className="flex items-center gap-1">
                {/* type */}
                <svg
                ...
                <p className={`${styles.headSub}`}>{job.contract_duration}</p>
              </div>
            </div>
          ))}
        </div>
                ...
                <div className="space-y-4">
                  <div className=" p-6 bg-white rounded-xl">
                    ...
                    <div className="flex flex-col gap-2 pb-2 ">
                      ...
                      <p className={`${styles.postingP}`}>
                        {job.company_overview.name}
                      </p>
                    </div>
                    <div className="flex flex-col  gap-2 pb-2 ">
                      <h3 className={styles.postingH3}>Description:</h3>
                      <p className={`${styles.postingP}`}>
                        {job.company_overview.description}
                      </p>
                    </div>
                  </div>
                  <div className=" p-6 bg-white rounded-xl">
