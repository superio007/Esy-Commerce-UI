          ...
          <div className="xl:px-10 3xl:mx-auto 3xl:max-w-screen-xl">
            <div className="px-6 md:px-0">
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Manufacturing</h2>
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Retail</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Finance</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Healthcare</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Technology</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Transportation</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Food and Beverage</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Construction</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div className={styles.DivSpace}>
                <h2 className={styles.PartnerH2}>Education</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
              ...
              <div>
                <h2 className={styles.PartnerH2}>Entertainment</h2>
                <div className="flex flex-wrap gap-6">
                  {logos.map((src, index) => (
                    <img
                      key={index}
