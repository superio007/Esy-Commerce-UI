...
const TeamSection = ({ heading, TeamMembers, subHeading }) => {
  ...
  return (
    <div className="xl:px-16 3xl:mx-auto 3xl:max-w-screen-xl">
      <div className={styles.TeamSection}>
        <div className="px-6 md:px-0">
          <div className="flex flex-col text-center gap-4 pb-8">
            <h2 className={styles.TeamH2}>{heading || "Our Team"}</h2>
          ...
          <div className="hidden md:flex justify-center items-center gap-4 relative">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                >
                  <div>
                    <h3 className={styles.TeamH3}>{member.name}</h3>
                    <p className={styles.Teamp}>{member.title}</p>
                  </div>
