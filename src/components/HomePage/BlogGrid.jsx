...
const BlogGrid = () => {
  ...
  return (
    <section ref={ref} className="relative  xl:py-12">
      ...
      >
        <h2 className="Land-Blog-Heading xl:text-6xl text-4xl font-bold leading-tight text-center">
          Our Blogs
        </h2>
      </section>
      <div
      ...
      >
        ...
        >
          <div className="blog-grid row-span-4 bg-[#007fff] rounded-2xl text-white h-[350px]">
            1
          </div>
          <div className="blog-grid col-span-3 row-span-4 bg-[#007fff] rounded-2xl text-white">
            2
          </div>
          <div className="blog-grid row-span-4 col-start-5 row-start-3 bg-[#007fff] rounded-2xl text-white">
            3
          </div>
          <div className="blog-grid row-span-2 col-start-5 row-start-1 bg-[#007fff] rounded-2xl text-white">
            4
          </div>
          <div className="blog-grid col-span-2 row-span-2 col-start-3 row-start-5 bg-[#007fff] rounded-2xl text-white">
            5
          </div>
          <div className="blog-grid col-span-2 row-span-2 col-start-1 row-start-5 bg-[#007fff] rounded-2xl text-white">
            6
          </div>
        </div>
      </div>
