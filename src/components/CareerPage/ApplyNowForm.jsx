...
const ApplyNowForm = () => {
 ...
 const title = jobTitle.title ? jobTitle.title.split("-").join(" ") : null;
  ...
  const onSubmit = async (data) => {
    ...
    const resumeURL = urlEndpoint + fileUrl;
    const formatedData = {
      data: {
        FullName: data.name,
        Email: data.Email,
    ...
    formatedData.data.FormTemplate = "jobapplyform";
      ...
      <div className="px-6 md:px-0">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center justify-center w-full my-4">
            <label
              htmlFor="pdf-upload"
              className="flex flex-col items-center justify-center w-full border-gray-500 h-60 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50"
            >
